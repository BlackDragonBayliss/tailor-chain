...
var ParticlesComponent = /** @class */ (function () {
    ...
    ParticlesComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(this.canvas, 'mousemove').subscribe(function (e) {
            _this.interaction.pos_x = e.offsetX;
            _this.interaction.pos_y = e.offsetY;
            _this.interaction.status = 'mousemove';
        });
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(this.canvas, 'mouseleave').subscribe(function (e) {
            _this.interaction.pos_x = null;
            _this.interaction.pos_y = null;
            _this.interaction.status = 'mouseleave';
        });
        this.render();
    };
    ParticlesComponent.prototype.ngOnDestroy = function () {
        this.animating = false;
    };
    ParticlesComponent.prototype.setCanvasSize = function () {
        this.canvasHeight = this.canvas.offsetHeight;
        this.canvasWidth = this.canvas.offsetWidth;
        this.canvas.width = this.canvasWidth;
        this.canvas.height = this.canvasHeight;
    };
    ParticlesComponent.prototype.createParticle = function () {
    ...
    ParticlesComponent.prototype.draw = function (p) {
    ...
    ParticlesComponent.prototype.particlesDraw = function () {
        this.context.clearRect(0, 0, this.canvasWidth, this.canvasHeight);
        this.update();
        for (var i = 0, l = this.particlesList.length; i < l; i++) {
            this.draw(this.particlesList[i]);
        }
    };
    ParticlesComponent.prototype.update = function () {
        var p = {
            vx: 0,
            vy: 0,
            x: 0,
    ...
    ParticlesComponent.prototype.repulse = function (p) {
        var dx_mouse = p.x - this.interaction.pos_x, dy_mouse = p.y - this.interaction.pos_y, dist_mouse = Math.sqrt(Math.pow(dx_mouse, 2) + Math.pow(dy_mouse, 2));
        var velocity = 100, repulseFactor = Math.min(Math.max((1 / this.repulseDistance)
    ...
    ParticlesComponent.prototype.linkParticles = function (p1, p2) {
    ...
    ParticlesComponent.prototype.render = function () {
        var _this = this;
        this.particlesDraw();
        if (this.animating) {
            window.requestAnimationFrame(function (callback) { return _this.render(); });
        }
    };
